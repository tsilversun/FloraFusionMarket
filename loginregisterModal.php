  ...
  <div class="modal-container">
    <div class="modal-content bg-white p-6 rounded-lg shadow-lg">
     ...
     <div class="mt-4 text-sm text-gray-600" onclick="toggleModal('loginModal', 'createAccountModal')">
            Don't have an account? <a href="#" id="create-account-link" class="text-blue-500 hover:underline">Create one</a>.
        </div>
    </div>
  </div>
</div>
...
<div id="createAccountModal" class="fixed inset-0 flex items-center justify-center z-50 hidden">
  <div class="bg-white p-8 rounded shadow-md w-80" id="CSRegister">
        ...
        <div class="mt-4 text-sm text-gray-600">
            Already have an account? <a href="#" id="login" class="text-blue-500 hover:underline" onclick="toggleModal('createAccountModal', 'loginModal')">Login</a>
        </div>
    </div>
    </div>
  </div>
