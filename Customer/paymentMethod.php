            ...
            <form id="order-details-form">
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="order-number" type="text" placeholder="Order Number" readonly>
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="order-date" type="text" placeholder="Date" readonly>
                </div>
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        id="customer-info" placeholder="Customer Info" readonly></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="total-amount" type="text" placeholder="Total Amount" readonly>
                </div>
